...
local Player, Buff, Debuff, Spell, Target, Trait, Talent, Item, GCD, CDs, HUD, Player5Y, Player5YC, Player10Y, Player10YC, SingleTarget, PriorityRotation, Stealth, Player40Y, Player40YC, Friends40Y, Friends40YC
local UI = DMW.UI
...
local function OOC()
    ...
    if Setting("Auto Stealth") ~= 1 and IsUsableSpell(Spell.Stealth.SpellName) and not Spell.Vanish:LastCast() and  IsResting() and (DMW.Time - Spell.Stealth.LastCastTime) > 0.2 then
